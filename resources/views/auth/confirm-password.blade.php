...
<head>
    ...
    <title>Confirm Access - Faruk AI</title>
...
<body class="bg-gray-50 font-sans min-h-screen flex items-center justify-center px-4">
    ...
    <div class="max-w-md w-full bg-white rounded-[2.5rem] shadow-xl shadow-blue-100/50 p-8 md:p-10 animate-fade-in border border-gray-100">
        ...
        <div class="flex flex-col items-center justify-center text-center mb-8">
            ...
            <h2 class="text-3xl font-extrabold text-gray-900 mb-2 tracking-tight">Security Check</h2>
        ...
        <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
            ...
            <!-- Cancel/Logout Option (Optional) -->
            <div class="pt-4 text-center">
                <a href="{{ route('search.index') }}" class="text-sm text-gray-400 font-bold hover:text-blue-600 transition-colors">
                    Cancel & Go Back
                </a>
            </div>
        </form>
